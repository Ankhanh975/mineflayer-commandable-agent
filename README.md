Below these few lines will be the README generated by AI. Hoever, I want to actually write about this project in a few short lines. Today is March 23th, 2026. 

This are bots just like in carpet bots but are more programmable, and also consume much less ram since we do not load the entire Minecraft client for the bots.
...
w- `Olivia dropall` - Drop all inventory items
